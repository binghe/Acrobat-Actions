...
;; line 194
(define-acrobat-function (as-register-error-string
...
;; line 246
(define-acrobat-function (as-fixed-matrix-transform
...
;; line 249
(define-acrobat-function (as-fixed-matrix-transform-rect
...
;; line 253
(define-acrobat-function (as-path-from-platform-path
...
;; line 257
(define-acrobat-function (as-get-default-file-sys
                          "ASGetDefaultFileSys")
                         *g-acro-support-version*
                         0
...
;; line 269
(define-acrobat-function (as-ram-file-sys-set-limit-kb
...
;; line 272
(define-acrobat-function (as-file-sys-di-path-from-path
...
;; line 275
(define-acrobat-function (as-file-sys-path-from-di-path
...
;; line 281
(define-acrobat-function (as-file-sys-release-path
...
;; line 287
(define-acrobat-function (as-file-sys-remove-file
                          "ASFileSysRemoveFile")
                         *g-acro-support-version*
                         0
...
(define-acrobat-function (as-file-flush "ASFileFlush")
                         ...
                         *g-acro-support-hft*
                         +as-file-flush-sel+)
;; line 317
(define-acrobat-function (as-file-acquire-path-name
...
(define-acrobat-function (as-stm-write "ASStmWrite")
                         ...
                         *g-acro-support-hft*
                         +as-stm-write-sel+)
;; line 343
(define-acrobat-function (as-file-unregister-file-sys
...
;; line 349
(define-acrobat-function (as-file-register-file-sys
...
;; line 352
(define-acrobat-function (as-file-get-file-sys-by-name
...
;; line 361
(define-acrobat-function (as-file-sys-create-path-name
...
;; line 364
(define-acrobat-function (as-file-sys-acquire-file-sys-path
...
;; line 446
(define-acrobat-function (as-file-sys-get-platform-thing
...
;; line 447
(define-acrobat-function (as-file-sys-acquire-platform-path
...
;; line 448
(define-acrobat-function (as-file-sys-release-platform-path
...
;; line 449
(define-acrobat-function (as-platform-path-get-cstring-ptr
...
;; line 451
(define-acrobat-function (as-platform-path-get-fs-spec-ptr
...
;; line 453
(define-acrobat-function (as-platform-path-get-fs-ref-ptr
...
;; line 454
(define-acrobat-function (as-platform-path-get-fs-ref-with-cf-string-ref-rec-ptr
...
;; line 455
(define-acrobat-function (as-platform-path-get-cfurl-ref-rec-ptr
...
;; line 456
(define-acrobat-function (as-platform-path-get-posix-path-ptr
...
(define-acrobat-function (as-stm-flush "ASStmFlush")
                         ...
                         *g-acro-support-hft*
                         +as-stm-flush-sel+)
;; line 461
(define-acrobat-function (as-file-has-outstanding-m-reads
...
(define-acrobat-function (hft-new-ex "HFTNewEx")
                         ...
                         *g-acro-support-hft*
                         +hft-new-ex-sel+)
;; line 465
(define-acrobat-function (as-file-sys-di-path-from-path-ex
...
;; line 466
(define-acrobat-function (as-file-sys-path-from-di-path-ex
...
;; line 479
(define-acrobat-function (as-file-sys-open-file64
                          "ASFileSysOpenFile64")
                         *g-acro-support-version*
                         +as-calls-hft-version-7+
...
;; line 480
(define-acrobat-function (as-file-sys-get-file-pos-limit
...
;; line 486
(define-acrobat-function (as-file-sys-get-name-from-path-for-display
...
;; line 491
(define-acrobat-function (as-get-default-unicode-file-sys
...
;; line 494
(define-acrobat-function (as-get-default-file-sys-for-path
...
;; line 496
(define-acrobat-function (as-file-sys-get-storage-free-space64
...
;; line 500
(define-acrobat-function (as-double-matrix-concat
...
;; line 501
(define-acrobat-function (as-double-matrix-invert
...
;; line 502
(define-acrobat-function (as-double-matrix-transform
...
;; line 503
(define-acrobat-function (as-double-matrix-transform-rect
...
;; line 504
(define-acrobat-function (as-file-open-with-virtual-eof
